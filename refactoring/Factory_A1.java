...
public abstract class Factory_A1 {
	...
	public static void main(String[] args){
		...
		Factory_A1 goodCustomer = customerFactory.getCustomer("Premier");
		...
		Factory_A1 badCustomer = customerFactory.getCustomer("Deadbeat");
...
class Premier extends Factory_A1{
...
class Deadbeat extends Factory_A1{
