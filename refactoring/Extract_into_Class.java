...
public class Extract_into_Class {
	...
	public Extract_into_Class(String firstName, String lastName, String street,
	...
	public Extract_into_Class(String firstName, String lastName, Address address,
			Birthday birthDay) {
		super();
		this.firstName = firstName;
		this.lastName = lastName;
	...
	public static void main(String[] args){
		...
		Extract_into_Class sallySmith = new Extract_into_Class("Sally", "Smith", "123 Main St", "Perry", "Iowa", 50220);
		...
		Extract_into_Class markJones = new Extract_into_Class("Mark", "Jones", markJonesAddress, markJonesBirthday);
...
class Address{
	...
	// this will return a preset string
