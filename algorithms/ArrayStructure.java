 ...
 * Java Algorithms 1 : An algorithm is just the steps you take to manipulate data. 
 * A data structure is the way data is arranged in memory. 
 * There are 3 main data structure operations I will focus on first being inserting, 
 * deleting and searching for data. 
 */
public class ArrayStructure {
	...
	public void deleteIndex(int index){
		...
		if(index < arraySize){
			...
			// NOTE: use -1 since array index starts at 0
	...
	// good for finding ALL matches instead of just one...
	// if you need only first match with no duplicates in array, use a Binary search
	...
	public static void main(String[] args){
		...
		System.out.println("Whats the value at 4? "+newArray.getValueAtIndex(4));
		
		System.out.println("Does array contain 11? " + newArray.doesArrayContainThisValue(11));
